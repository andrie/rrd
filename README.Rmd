...
------------- | -----------------------------------------
Ubuntu        | `apt-get install rrdtool-dev`
RHEL / CentOS | `yum install rrdtool-devel`
Fedora        | `dnf install rrdtool-devel`
OSX           | `brew install rrdtool-dev`
Windows       | Not available

Note: on OSX you should also update `xcode`, using `xcode-select --install`.
...
```{r out.width="90%", fig.height=3, fig.width=8}
library(ggplot2)
