...
#' 
#' Andrie de Vries became maintainer of the package early in 2018, and prepared the package for release to CRAN by adding documentation, examples and unit tests. At this time the API changed so resulting objects are `tibble` objects, making it easier to analyse data using `tidyverse` concepts.  At this time he also published the "R Views" [blog post](https://rviews.rstudio.com/2018/06/20/reading-rrd-files/).
#' 
#' 
#' @name rrd-package
#' @aliases rrd
